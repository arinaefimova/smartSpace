...
class SelectConstructor {
    constructor(props, data = null) {
        ...
        this.selectClasses = {
            ...
            classSelectValue: "select__value", // Значение у заголовка
    ...
    getSelectElementContent(selectOption) {
        ...
        selectOptionContentHTML += selectOptЕсли выбран элемент со своим классомionData ? `<span class="${this.selectClasses.classSelectData}">` : '';
    ...
    optionAction(selectItem, originalSelect, optionItem) {
        ...
        if (!selectOptions.classList.contains('_slide')) {
            if (originalSelect.multiple) { // Если мультивибор
